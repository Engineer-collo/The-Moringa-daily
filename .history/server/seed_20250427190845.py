from app import app, db  # Make sure 'app' and 'db' are imported from your Flask app
from models import User, Profile, Content, Category, Subscription, ContentSubscription, Wishlist, Comment, Like, Notification, Share  # Adjust according to your project structure
...
def create_sample_data():
    with app.app_context():  # Ensure the app context is available for db operations
