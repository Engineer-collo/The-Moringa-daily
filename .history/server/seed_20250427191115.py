...
from models import User, Profile, Content, Category, Subscription, ContentSubscription, Wishlist, Comment, Like, Notification, Share
...
def create_sample_data():
    with app.app_context():  # Ensure the app context is available for db operations
        ...
        # Create some sample content posts, ensuring the author_id is correctly set
