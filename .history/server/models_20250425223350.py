...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///moringa_platform.db'  # You can change this to another database if needed
...
@app.route('/')
def home():
    return "Welcome to the Moringa Social Platform!"
