"""Initial migration with requested_writer

Revision ID: 4e8fafc1319f
Revises: 
Create Date: 2025-05-11 03:39:36.380453
...
def upgrade():
    ...
    sa.Column('requested_writer', sa.Boolean(), nullable=True),
